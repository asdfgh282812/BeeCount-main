...
abstract class AppLocalizations {
  ...
  /// No description provided for @recurringRuleEditTitle.
  ///
  /// In en, this message translates to:
  /// **'Edit Recurring Rule'**
  String get recurringRuleEditTitle;

  /// No description provided for @recurringFieldType.
  ///
  /// In en, this message translates to:
  /// **'Type'**
  String get recurringFieldType;

  /// No description provided for @recurringFieldAccount.
  ///
  /// In en, this message translates to:
  /// **'Account'**
  String get recurringFieldAccount;

  /// No description provided for @recurringFieldMerchant.
  ///
  /// In en, this message translates to:
  /// **'Merchant'**
  String get recurringFieldMerchant;

  /// No description provided for @recurringFieldTags.
  ///
  /// In en, this message translates to:
  /// **'Tags'**
  String get recurringFieldTags;

  /// No description provided for @recurringFieldTagsEmpty.
  ///
  /// In en, this message translates to:
  /// **'No tags selected'**
  String get recurringFieldTagsEmpty;

  /// No description provided for @recurringFieldFrequency.
  ///
  /// In en, this message translates to:
  /// **'Frequency'**
  String get recurringFieldFrequency;

  /// No description provided for @recurringFieldInterval.
  ///
  /// In en, this message translates to:
  /// **'Interval'**
  String get recurringFieldInterval;

  /// No description provided for @recurringFieldNextRunAt.
  ///
  /// In en, this message translates to:
  /// **'Next Run At'**
  String get recurringFieldNextRunAt;

  /// No description provided for @recurringFieldEndAtOptional.
  ///
  /// In en, this message translates to:
  /// **'End Date (Optional)'**
  String get recurringFieldEndAtOptional;

  /// No description provided for @cardRewardRuleSelectedCount.
  ///
  /// In en, this message translates to:
  /// **'{count} selected'**
  String cardRewardRuleSelectedCount(int count);

  /// No description provided for @recurringApplyFutureConfirmTitle.
  ///
  /// In en, this message translates to:
  /// **'Apply to future transactions?'**
  String get recurringApplyFutureConfirmTitle;

  /// No description provided for @recurringApplyFutureConfirmMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @recurringRuleEnabledLabel.
  ///
  /// In en, this message translates to:
  /// **'In Progress'**
  String get recurringRuleEnabledLabel;

  /// No description provided for @recurringRuleDisabledLabel.
  ///
  /// In en, this message translates to:
  /// **'Ended'**
  String get recurringRuleDisabledLabel;

  /// No description provided for @recurringRuleTerminateFutureLabel.
  ///
  /// In en, this message translates to:
  /// **'Terminate Future Occurrences'**
  String get recurringRuleTerminateFutureLabel;

  /// No description provided for @recurringRuleTerminateFutureConfirmTitle.
  ///
  /// In en, this message translates to:
  /// **'Terminate Future Occurrences'**
  String get recurringRuleTerminateFutureConfirmTitle;

  /// No description provided for @recurringRuleTerminateFutureConfirmMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @recurringOccurrenceOverriddenLabel.
  ///
  /// In en, this message translates to:
  /// **'Edited individually'**
  String get recurringOccurrenceOverriddenLabel;

  /// No description provided for @recurringOccurrenceUpdateFrom.
  ///
  /// In en, this message translates to:
  /// **'Apply from here on'**
  String get recurringOccurrenceUpdateFrom;

  /// No description provided for @recurringOccurrenceEdit.
  ///
  /// In en, this message translates to:
  /// **'Edit'**
  String get recurringOccurrenceEdit;

  /// No description provided for @recurringOccurrenceDelete.
  ///
  /// In en, this message translates to:
  /// **'Delete'**
  String get recurringOccurrenceDelete;

  /// No description provided for @recurringRuleExpand.
  ///
  /// In en, this message translates to:
  /// **'Expand'**
  String get recurringRuleExpand;

  /// No description provided for @recurringRuleCollapse.
  ///
  /// In en, this message translates to:
  /// **'Collapse'**
  String get recurringRuleCollapse;

  /// No description provided for @recurringRuleOccurrencesEmpty.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @notificationLedgerNotSynced.
  ///
  /// In en, this message translates to:
  /// **'The related ledger hasn\'t synced to this device yet'**
  String get notificationLedgerNotSynced;

  /// No description provided for @notificationTargetNotFound.
  ///
  /// In en, this message translates to:
