...
const Map<String, Set<String>> _zhAliases = {
  // 无歧义(繁体/台湾常用说法排在前面,是 zhAliasesForCode 取的「规范名」——
  // 决定 prompt 里实际显示给 AI 的中文名;简体写法仍保留在后面供解析辨识)
  '人民幣': {'CNY'}, '人民币': {'CNY'}, '元人民币': {'CNY'}, '软妹币': {'CNY'},
  '美元': {'USD'}, '美金': {'USD'}, '美刀': {'USD'},
  '日圓': {'JPY'}, '日元': {'JPY'}, '日圆': {'JPY'}, '日幣': {'JPY'}, '日币': {'JPY'},
  '歐元': {'EUR'}, '欧元': {'EUR'}, '歐': {'EUR'}, '欧': {'EUR'},
  '英鎊': {'GBP'}, '英镑': {'GBP'},
  '港幣': {'HKD'}, '港币': {'HKD'}, '港元': {'HKD'},
  '新台幣': {'TWD'}, '台幣': {'TWD'}, '新臺幣': {'TWD'}, '新台币': {'TWD'}, '臺幣': {'TWD'}, '台币': {'TWD'},
  '韓元': {'KRW'}, '韩元': {'KRW'}, '韓幣': {'KRW'}, '韩币': {'KRW'},
  '泰銖': {'THB'}, '泰铢': {'THB'},
  '新加坡元': {'SGD'}, '坡幣': {'SGD'}, '坡币': {'SGD'}, '新幣': {'SGD'}, '新币': {'SGD'},
  '澳元': {'AUD'}, '澳幣': {'AUD'}, '澳币': {'AUD'}, '澳大利亞元': {'AUD'}, '澳大利亚元': {'AUD'},
  '加元': {'CAD'}, '加幣': {'CAD'}, '加币': {'CAD'}, '加拿大元': {'CAD'},
  '瑞郎': {'CHF'}, '瑞士法郎': {'CHF'},
  '盧布': {'RUB'}, '卢布': {'RUB'},
  '越南盾': {'VND'}, '盾': {'VND'},
  '林吉特': {'MYR'}, '馬幣': {'MYR'}, '马币': {'MYR'},
  '印尼盾': {'IDR'}, '印尼盧比': {'IDR'},
  '紐幣': {'NZD'}, '纽币': {'NZD'}, '紐西蘭元': {'NZD'}, '新西兰元': {'NZD'},
  '雷亞爾': {'BRL'}, '雷亚尔': {'BRL'},
  '蘭特': {'ZAR'}, '兰特': {'ZAR'},
  '澳門幣': {'MOP'}, '澳門元': {'MOP'}, '澳门元': {'MOP'}, '澳门币': {'MOP'},
  '印度盧比': {'INR'}, '印度卢比': {'INR'},
  '菲律賓披索': {'PHP'}, '菲律宾比索': {'PHP'},
  '土耳其里拉': {'TRY'},
  '沙特里亞爾': {'SAR'}, '沙特里亚尔': {'SAR'},
